...
import { 
  Activity,Bell,Book,Command, Edit,Hexagon,type LucideIcon, Table, Trash,
  User2,
  Users
} from "lucide-react";
...
import UserTaskDashBoard from "./userTaskDashBoard/userDashBoard";
...
import UserFullCard from "./userComponents/usersCards/UserFullCard";
...
import BreakTaskModal from "../pages/breakTaskModal/TaskModal";
import { addIdMethod, fetchBreakTask } from "../redux/reduxSlice/breakTaskSlice";
import ResoureAllocation from "../updateDesign/adminComponents/resourceAllocation/resourceAllocation";
import { useCommandListQuery } from "../redux/userCommandApi/UserCommandApi";
import CommandModalSearch from "../pages/commandModal/FindCommandModal";
...
export default function UserMainPage() {
  ...
  const { setSignalOpenAssignTask, signalOpenAssignTask, setRole, mainTask, setToggle, id } = useContext(UserContext) || {};
  ...
  useEffect(()=>{
    if(id){
      dispatch(addIdMethod(id));
      dispatch(fetchBreakTask({ taskType:'mainTask', id:id || '' }));
    }
  }, [id]);
  ...
  return (
    <div
      className={`${theme} min-h-screen ${isLoading ? 'max-h-screen' : 'min-h-screen'} bg-gradient-to-br from-black to-slate-900 text-slate-100 
...
/>
        ...
        <NotificationModal/>  
        <CommandModalSearch 
        commandList={commandList} commandModal={openCommandSearch} setCommandModal={setOpenCommandSearch}/> 
        ...
        <header className="flex items-center justify-between py-4 border-b border-slate-700/50 mb-6">
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              { data?.image ? (
              <img 
               width={"50px"} height={"50px"} className='
            ...
            <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm h-full">
              <CardContent className="p-4">
                <nav className="space-y-2">
                  <NavItem icon={Command} onClick={()=>navigate('/user')} label="Dashboard" active />
          ...
          <div className="col-span-12 md:col-span-9 lg:col-span-7">
            <div className="grid gap-6">
              ...
              <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm overflow-hidden">
                ...
                <UserTaskDashBoard editOrDelete={editOrDelete}/>
                <CreateTaskContent setOpenModal={setOpenModal} openModal={openModal} userType="user"/>           
              </Card>
