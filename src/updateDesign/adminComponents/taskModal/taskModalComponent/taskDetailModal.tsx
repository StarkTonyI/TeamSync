...
type TaskDetailsModalProps = {
  ...
  usersList:TeamMember[] | undefined;
};
        ...
        <div className="relative flex flex-col min-h-[50vh]">
          ...
          <div className="bg-[#22304D] p-6 border-b border-slate-700">
            <div className="flex items-start justify-between">
              <div onClick={() => toggleExpand("title")}>
                <h2 className="text-2xl font-bold text-white">
                  Title:{truncate(task?.title || '', expanded.title)}
                </h2>
          ...
          <div className="p-6 flex-grow space-y-6">
            {/* Description */}
            <div onClick={() => toggleExpand("description")}>
              <h3 className="text-lg font-medium mb-2 text-slate-200">Description</h3>
              <p className="text-slate-300 whitespace-pre-line">
                {truncate(task?.description || '', expanded.description)}
              </p>
            </div>
